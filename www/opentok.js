...
TBPublisher = (function () {
    function TBPublisher(targetElement, properties, completionHandler) {
        ...
        var borderRadius, cameraName, height, name, obj, onError, onSuccess, position, publishAudio, publishVideo, ratios, width, zIndex, _ref, _ref1, _ref2, _ref3, zIndexParent;
...
TBSession = (function () {
    ...
    function TBSession(apiKey, sessionId) {
        ...
        this.signalSent = __bind(this.signalSent, this);
    ...
    //indicador se mensagem foi enviada com sucesso
    TBSession.prototype.signalSent = function (event) {
        pdebug('signalSent', event);
    }
